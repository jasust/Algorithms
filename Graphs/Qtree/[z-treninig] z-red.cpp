/*
  Dato je stablo kod koga je svaki cvor obojen crveno ili plavo
   i dati su upiti dva tipa:
  1) Promeni boju cvora
  2) Nadji k-ti po redu od korena do datog cvora
*/
#include <cstdio>
#include <vector>
