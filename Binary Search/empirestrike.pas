{Za zadatih k (k<10^6) brojeva manjih od 10^7 odrediti najmanji broj n takav
 da je p/q prirodan broj, gde je p=n!, a q=a1!*a2!..ak!}
program empire;
const maxn=10000010;
      maxans:int64=9999998000005; //ocigledno je upper bound za n a1+a2+..+ak
var m,cm:int64; n,i,j,x:longint;
    ca,p:array[0..maxn+10] of longint; //slozenost algoritma je maxn*log(maxans)
...
var mid,ll,rr:int64;
begin                        // binarna pretraga najmanjeg broja takvog da
  ll:=1; rr:=maxans;         // x deli faktorijel tog broja tacno t puta
  while (ll<rr-1)do
  begin
    mid:=(ll+rr) shr 1;
