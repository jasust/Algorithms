/*
  Dato je tezinsko stablo i dati su upiti
  dva tipa. Upit prvog tipa zahteva da se izmeni
  tezina i-te ivice. Upit drugog tipa zahteva da
  se ispise tezina najvece ivice na prostom putu
  od a do b.
*/
